...
class AipImageProcess extends AipBase
{
     ...
     * @return array
     */
    public function colourize($image, $options = [])
    {
     ...
     * @return array
     */
    public function stretchRestore($image, $options = [])
    {
     ...
     * @return array
     */
    public function selfieAnime($image, $options = [])
    {
     ...
     * @return array
     */
    public function imageDefinitionEnhance($image, $options = [])
    {
     ...
     * @return array
     */
    public function styleTrans($image, $options = [])
    {
     ...
     * @return array
     */
    public function skySeg($image, $options = [])
    {
     ...
     * @return array
     */
    public function inpaintingByMask($image, $rectangle, $options = [])
    {
