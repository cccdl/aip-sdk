...
class AipFace extends AipBase
{
    ...
    /**
     * 身份证与名字比对 person_idmatch api url
     * @var string
     */
    private $personIdmatchUrl = 'https://aip.baidubce.com/rest/2.0/face/v3/person/idmatch';
     ...
     *
     */
    public function personIdmatch($name, $idCardNumber)
    {

        $data['name'] = $name;
        $data['id_card_number'] = $idCardNumber;
        return $this->request($this->personIdmatchUrl, json_encode($data), [
            'Content-Type' => 'application/json',
        ]);
    }
