...
class AipImageClassify extends AipBase
{
     ...
     * @return array
     */
    public function vehicleDetect($image, $options = [])
    {
     ...
     * @return array
     */
    public function vehicleDamage($image, $options = [])
    {
     ...
     * @return array
     */
    public function customDishesAddImage($image, $brief, $options = [])
    {
     ...
     * @return array
     */
    public function customDishesSearch($image, $options = [])
    {
     ...
     * @return array
     */
    public function customDishesDeleteImage($image, $options = [])
    {
     ...
     * @return array
     */
    public function customDishesDeleteContSign($contSign, $options = [])
    {
     ...
     * @return array
     */
    public function multiObjectDetect($image, $options = [])
    {
     ...
     * @return array
     */
    public function combinationByImage($image, $scenes, $options = [])
    {
        ...
        return $this->request($this->combinationUrl, json_encode($data), ['Content-Type' => 'application/json;charset=utf-8']);
    }
     ...
     * @return array
     */
    public function combinationByImageUrl($imageUrl, $scenes, $options = [])
    {
